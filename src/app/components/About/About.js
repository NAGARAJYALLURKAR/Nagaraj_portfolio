...
import myAboutImage from "../../assets/images/nagaraj.jpg";
        ...
        <section className="aboutLeftSec">
          <div className="aboutLeftSecWrapper">
            ...
            <p className="about-para">
              ...
              based in Dandeli, India. I'm an undergraduate student from KLS
              VDIT, and my journey in web development began during my final year
